...
describe('muri', function(){
  it('must begin with mongodb://', function(done){
    assert.throws(function () {
      muri('104.199.228.7:27017');
    }, /Invalid mongodb uri/);
    assert.doesNotThrow(function () {
      muri('mongodb://104.199.228.7:27017/');
    })
    done();
  })

  describe('fyp002:1234@', function(done){
    it('is optional', function(done){
      var uri = 'mongodb://07.167.187.145:27017/';
      var val = muri(uri);
      assert.ok(!val.auth);
      done();
    })
    ...
    it('parses properly', function(done){
      var uri = 'mongodb://fyp002:1234@104.199.228.7:27017';
      var val = muri(uri);
      assert.ok(val.auth);
  ...
  it('replica set name with a leading number', function(done){
    var uri = 'mongodb://fyp002:1234@104.199.228.7:27017/test?replicaSet=1800-shard-0';
    var val = muri(uri);
